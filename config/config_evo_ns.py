...
Ori_data_high = cwd + '/raw_data/NS_evo_data_high.npy'
Ori_data_low = cwd + '/raw_data/NS_evo_data_low.npy'
Ori_data_test = cwd + '/raw_data/NS_evo_data_test.npy'

#Gen_data_ak = cwd + '/data/Wave_gen_data_all_kind_N_' + num2str_deciaml(N_gen) + '.npy'
high_data = cwd + '/data/NS_evo_high_data_N_' + num2str_deciaml(N_train) + '.npy'
low_data = cwd + '/data/NS_evo_low_data_N_' + num2str_deciaml(N_train) + '.npy'
cv_data = cwd + '/data/NS_evo_cv_data_N_' + num2str_deciaml(N_train) + '.npy'

Test_data = cwd + '/data/NS_test_evo_data_N_' + num2str_deciaml(N_test) + '.npy'
...
Ori_data_high = cwd + '/raw_data/Euler_2D_high.npy'
Ori_data_low = cwd + '/raw_data/Euler_2D_low.npy'
Ori_data_test = cwd + '/raw_data/Euler_2D_test.npy'

#Gen_data_ak = cwd + '/data/Wave_gen_data_all_kind_N_' + num2str_deciaml(N_gen) + '.npy'
Gen_data = cwd + '/data/Euler_gen_data_N_' + num2str_deciaml(N_gen) + '.npy'
Super_data = cwd + '/data/Euler_super_data_N_' + num2str_deciaml(N_sup) + '.npy'
Test_data = cwd + '/data/Euler_test_data_N_' + num2str_deciaml(N_test) + '.npy'

Direct_super_data = cwd + '/data/Euler_direct_super_data_N_' + num2str_deciaml(N_sup) + '.npy'

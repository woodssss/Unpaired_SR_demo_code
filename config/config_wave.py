...
Ori_data_high = cwd + '/raw_data/Wave_data_high.npy'
Ori_data_low = cwd + '/raw_data/Wave_data_lowo.npy'
Ori_data_test = cwd + '/raw_data/Wave_data_test.npy'

#Gen_data_ak = cwd + '/data/Wave_gen_data_all_kind_N_' + num2str_deciaml(N_gen) + '.npy'
Gen_data = cwd + '/data/Wave_gen_data_N_' + num2str_deciaml(N_gen) + '.npy'
Super_data = cwd + '/data/Wave_super_data_N_' + num2str_deciaml(N_sup) + '.npy'
Test_data = cwd + '/data/Wave_test_data_N_' + num2str_deciaml(N_test) + '.npy'

Low_data_cv = cwd + '/data/Wave_low_data_N_' + num2str_deciaml(N_gen) + '.npy'